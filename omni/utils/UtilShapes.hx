...
/**
 *
 * Drawing shortcuts for common vector shapes in Haxe OpenFL
 *
 * Ported to Haxe from http://www.funky-monkey.nl/blog/2010/04/20/drawing-shapes-in-as3-a-class-to-draw-an-arc-star-gear-cog-wedge-and-a-burst/
 *
